...
var propTypes = {
  ...
  testHovered: _propTypes2.default.func.isRequired,
...
var Month = function (_Component) {
  ...
  _createClass(Month, [{
    ...
    key: 'testHovered',
    value: function testHovered(day) {
      var _props3 = this.props,
          selectedRange = _props3.selectedRange,
          testHovered = _props3.testHovered;
    ...
    value: function renderMonthDays() {
      ...
      var _props4 = this.props,
          year = _props4.year,
          month = _props4.month,
          forceFullWeeks = _props4.forceFullWeeks,
          showWeekSeparators = _props4.showWeekSeparators,
          selectedDay = _props4.selectedDay,
          firstDayOfWeek = _props4.firstDayOfWeek,
          selectingRange = _props4.selectingRange,
          selectRange = _props4.selectRange,
          selectedRange = _props4.selectedRange,
          customClasses = _props4.customClasses;
      ...
      (0, _utils.range)(firstDayOfWeek + 1, totalDays + firstDayOfWeek + 1).forEach(function (i) {
        ...
        days.push(_react2.default.createElement(_Day2.default, {
          ...
          testHovered: function testHovered(d) {
            return _this2.testHovered(d);
          },
