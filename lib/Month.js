...
var propTypes = {
  ...
  onDayMouseLeft: _propTypes2.default.func.isRequired
};
...
var Month = function (_Component) {
  ...
  _createClass(Month, [{
    ...
    key: 'onDayMouseLeft',
    value: function onDayMouseLeft(day) {
      var onDayMouseLeft = this.props.onDayMouseLeft;
    ...
    value: function renderMonthDays() {
      ...
      (0, _utils.range)(firstDayOfWeek + 1, totalDays + firstDayOfWeek + 1).forEach(function (i) {
        ...
        days.push(_react2.default.createElement(_Day2.default, {
          ...
          onDayMouseLeft: function onDayMouseLeft(d) {
            return _this2.onDayMouseLeft(d);
          }
        }));
      });
